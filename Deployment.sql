...
-- Initial Value
    ...
    FROM (
        SELECT 'Red' AS color_name, '#FF0000' AS color_hex UNION ALL
        SELECT 'Green', '#00FF00' UNION ALL
        SELECT 'Blue', '#0000FF' UNION ALL
        SELECT 'Yellow', '#FFFF00' UNION ALL
        SELECT 'Cyan', '#00FFFF' UNION ALL
        SELECT 'Magenta', '#FF00FF' UNION ALL
        SELECT 'Black', '#000000' UNION ALL
        SELECT 'White', '#FFFFFF' UNION ALL
        SELECT 'Orange', '#FFA500' UNION ALL
        SELECT 'Purple', '#800080'
    ) AS tmp
    ...
    FROM (
        ...
        SELECT 'ALL SIZE', 'ALLSIZE' UNION ALL
        SELECT 'BIG SIZE', 'BIGSIZE' UNION ALL
    ...
    FROM (
        ...
        SELECT 'SWEATER DIAMOND NITO', 'SWEATER DIAMOND NITO' UNION ALL
        SELECT 'RAGLAN PANJANG', 'RAGLAN PANJANG' UNION ALL
        SELECT 'RAGLAN PENDEK', 'RAGLAN PENDEK' UNION ALL
        SELECT 'CARD HOLDER', 'CARD HOLDER' UNION ALL
